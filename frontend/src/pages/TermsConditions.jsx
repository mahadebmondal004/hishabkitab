...
const TermsConditions = () => {
    ...
    useEffect(() => {
        const fetchPage = async () => {
            try {
                const res = await api.get('/admin/cms/pages/terms-and-conditions');
    ...
    const content = pageContent?.content || '<p>Loading terms and conditions...</p>';
            ...
            <div className="bg-gradient-to-r from-blue-600 to-red-600 p-6 pt-8 pb-10 rounded-b-[2.5rem] shadow-xl text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-blue-100 text-xs">Usage guidelines</p>
                    </div>
                </div>
            </div>
